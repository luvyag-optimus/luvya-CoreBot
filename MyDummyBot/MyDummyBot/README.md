...
```json
  ...
  "LuisAPIKey": "Your LUIS Subscription key here",  "LuisAPIHostName": "Your LUIS App region here (i.e: westus.api.cognitive.microsoft.com)"
```

## To try this sample

- In a terminal, navigate to `MyDummyBot`
...
- Run the bot from a terminal or from Visual Studio, choose option A or B.
  ...
  - Navigate to `MyDummyBot` folder
  - Select `MyDummyBot.csproj` file
